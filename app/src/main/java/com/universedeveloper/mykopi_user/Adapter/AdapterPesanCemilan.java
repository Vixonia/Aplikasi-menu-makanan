...
public class AdapterPesanCemilan extends RecyclerView.Adapter<AdapterPesanCemilan.ViewHolder> implements Filterable {
    private ArrayList<ModelMenu> mArrayList;
    private ArrayList<ModelMenu> mFilteredList;
    private Context context;

    public AdapterPesanCemilan(ArrayList<ModelMenu> arrayList) {
        this.mArrayList = arrayList;
        this.mFilteredList = arrayList;
    }

    @Override
    public AdapterPesanCemilan.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_adapter_pesan_cemilan, viewGroup, false);
        context = viewGroup.getContext();
        return new AdapterPesanCemilan.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull AdapterPesanCemilan.ViewHolder viewHolder, int i) {
        ...
        public ViewHolder(View view) {
            ...
            image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent detail = new Intent(view.getContext(), DetailPesanCemilan.class);
