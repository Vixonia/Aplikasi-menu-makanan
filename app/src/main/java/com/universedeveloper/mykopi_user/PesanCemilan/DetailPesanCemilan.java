...
public class DetailPesanCemilan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(DetailPesanCemilan.this)
                .load(gambar)
        ...
        btnpesanmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (stok.equals("Habis")){
                    Toast.makeText(DetailPesanCemilan.this, "Maaf menu habis", Toast.LENGTH_SHORT).show();
                }else {
                    //pakai alert dialog YA ATAU TIDAK untuk keluar dari aplikasi
                    android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(DetailPesanCemilan.this);
