...
import com.universedeveloper.mykopi_user.Adapter.AdapterPesanMinuman;
...
public class PesanMinum extends Fragment {
    FloatingActionButton fab;
    RecyclerView listminum;
    ...
    AdapterPesanMinuman adapterPesanMinuman;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pesan_minum, container, false);
        listminum = view.findViewById(R.id.listminum);
    ...
    private void initViews(){
        listminum.setHasFixedSize(true);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        listminum.setLayoutManager(layoutManager);
    }
    private void loadJSON(){
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapterPesanMinuman = new AdapterPesanMinuman (mArrayList);
                listminum.setAdapter(adapterPesanMinuman);
            }
